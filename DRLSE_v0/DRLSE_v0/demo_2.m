...
%{ load image SETUP %} 
filename = 'subject_1_t2w_register.nii'; % NIfTI image file name
% Img = imread('twocells.bmp'); % real miscroscope image of cells                     EDIT THIS ONE
...
%{
Initializae the level set function
