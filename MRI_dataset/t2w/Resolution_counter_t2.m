...
directory = 'C:\Users\willi\OneDrive - The Webb Schools\Documents\Sophmore Spring\Med Image Analysis\mia_s24_mri_project\t2w';
...
for i = 1:length(keys)
    fprintf('%d\n',voxelDimCount(keys{i})); %keys{i}); %, voxelDimCount(keys{i}));
end
