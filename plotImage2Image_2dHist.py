...
def plotImage2Image_2dHist( MapX, MapY, thresholdX=None, thresholdY=None, logY=None, logX=None, filterX=None, filterY=None, bins=100 ):
    ...
    mainFig.canvas.manager.set_window_title((MapX + ' vs. ' + MapY))
...
MapX = r'MRI_dataset\t1W in MNI\subject_1_t1w_aligned2_register.nii'
MapY = r'MRI_dataset\t2w in MNI\subject_1_t2w_register.nii'

plotImage2Image_2dHist(MapX, MapY, thresholdX=None, thresholdY=None, logY=None, logX=None, filterX=None, filterY=None, bins=100)   
